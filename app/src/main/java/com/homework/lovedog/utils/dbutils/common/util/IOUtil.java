...
public class IOUtil {
    ...
    synchronized public static String readStr(InputStream in, String charset) throws IOException {
    ...
    synchronized public static void copy(InputStream in, OutputStream out) throws IOException {
        if (!(in instanceof BufferedInputStream)) {
            in = new BufferedInputStream(in);
        }
    ...
    synchronized public static boolean deleteFileOrDir(File path) {
